import{A as e,h as n}from"./headers-C2fTOECc.js";import{s as i}from"./app-oy0XX8pY.js";async function c(o){const t=`${e}/${o}?_author=true`,a=await fetch(t,{headers:n()});if(!a.ok){const r=await a.json();throw new Error(r.errors?.[0]?.message||"Failed to load post")}return(await a.json()).data}async function d(o){try{const t=await c(o),a=document.getElementById("post-page");a.innerHTML=`
